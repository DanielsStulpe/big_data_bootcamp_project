...
CREATE TABLE CALIFORNIA_COVID_ANALYTICS.ANALYTICS.CASES AS
SELECT * FROM CALIFORNIA_COVID19_DATASETS.COVID.CASES;

CREATE TABLE CALIFORNIA_COVID_ANALYTICS.ANALYTICS.CASES_DEMOGRAPHICS AS
SELECT * FROM CALIFORNIA_COVID19_DATASETS.COVID.CASES_DEMOGRAPHICS;

CREATE TABLE CALIFORNIA_COVID_ANALYTICS.ANALYTICS.HOSPITALS_BY_COUNTY AS
SELECT * FROM CALIFORNIA_COVID19_DATASETS.COVID.HOSPITALS_BY_COUNTY;
...
SELECT
    ...
    D.FIPS
FROM CALIFORNIA_COVID_ANALYTICS.ANALYTICS.CASES C
